...
public class UpdateOfferRequest {
    ...
    @Schema(description = "A detailed description of the offer's content or condition.", example = "This is an updated mountain bike, ideal for off-road trails.")
    ...
    @Schema(description = "Optional custom email to associate with the offer if not using saved contact information. " +
            ...
            example = "updated.custom.email@example.com",
            nullable = true)
